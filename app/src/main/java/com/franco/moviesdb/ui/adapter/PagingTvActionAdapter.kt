...
class PagingTvActionAdapter(private val scope: CoroutineScope) :
        ListAdapter<MovieActionDomain, PagingTvActionAdapter.ItemViewHolder>(DiffCallBackFromAdapter()) {
    ...
    override fun onBindViewHolder(holder: ItemViewHolder, position: Int) = with(holder) {
        ...
        scope.collectFlow(itemView.onClickEvents) {
            ...
            navController!!.navigate(R.id.action_navigation_tv_action_to_detailFragment, bundle)
